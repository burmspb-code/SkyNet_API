...
def mock_token_headers(mocker):
    ...
    return mocker.patch("src.utils.token_open_sky.TokenManager.headers", return_value={"Authorization": "Bearer test"})
...
def coordinator():
    ...
    with patch('src.base.OpenApiIntegrator.get_countries_checklist'), \
